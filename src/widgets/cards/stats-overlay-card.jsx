  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-start">
      ...
      <div className="relative lg:w-2/3 w-full">
        ...
        <div className="absolute -bottom-6 -right-6 bg-green-800 rounded-xl p-6 shadow-lg">
          <div className="flex gap-8">
            {/* Första statistik-sektion */}
            <div className="text-white text-center">
              <Typography variant="small" className="mb-1 opacity-90 font-medium">
                Antal anställda
              </Typography>
              <Typography variant="h2" className="mb-1 font-bold text-3xl lg:text-4xl">
                120
              </Typography>
            ...
            <div className="text-white text-center border-l border-white/30 pl-8">
              <Typography variant="small" className="mb-1 opacity-90 font-medium">
                Antal kontor
              </Typography>
              <Typography variant="h2" className="mb-1 font-bold text-3xl lg:text-4xl">
